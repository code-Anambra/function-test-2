...
/*1. What is a function in Dart?
 Ans. Function is a set of statements that take inputs, do some specific computation and produces output.*/
int add(int a, int b){
  int result = a+b;
  return result;
}
...
function is declared by specifying the function return type or void if the function did not return any value, function name, function parameters
and body of the function, between curly braces.
Example 1 is an example of declared function

3.What is the purpose of the main() function in Dart?
Ans. The main () function is responsible for all kinds of execution, including user-defined statements, functions and libraries. 
The program starts with main () function, which contains variable declarations, functions and user-defined executable statements,
